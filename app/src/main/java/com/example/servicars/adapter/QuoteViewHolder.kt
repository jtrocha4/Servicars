...
class QuoteViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun render(quoteModel: Quote, onClickDelete: (Quote) -> Unit) {
        binding.vehiculoTxt.text =
            "${quoteModel.marcaAuto} ${quoteModel.modeloAuto} ${quoteModel.anioAuto}"
        ...
        binding.deleteQuoteBtn.setOnClickListener {
            onClickDelete(quoteModel)
        }
    }
